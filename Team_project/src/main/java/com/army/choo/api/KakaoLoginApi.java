...
public class KakaoLoginApi {
	...
	private final static String K_CLIENT_ID = "e2ae2da091765540d6419c005c1a3c6c"; 
	// 카카오 개발자 페이지에서  로그인 Redirect URI 에 설정한 값 
	private final static String K_REDIRECT_URI = "http://localhost:8090/choo/kakaologinok";
