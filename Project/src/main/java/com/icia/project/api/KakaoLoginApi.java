...
public class KakaoLoginApi {
	...
	private final static String K_CLIENT_ID = "fa8958f22f786e1f9f216310ecb51062"; 
	// 카카오 개발자 페이지에서  로그인 Redirect URI 에 설정한 값 
	private final static String K_REDIRECT_URI = "http://localhost:8090/project/kakaologinok";
