...
public class NaverLoginApi {
	...
	private final static String CLIENT_ID = "fNSa_71Cdy17xaDcNLWk";
	private final static String CLIENT_SECRET = "FJHfZ1GzJw";

	private final static String REDIRECT_URI = "http://localhost:8090/project/naverloginok";
